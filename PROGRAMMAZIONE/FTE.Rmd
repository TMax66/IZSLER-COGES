---
title: "Analisi dei carichi di lavoro in FTE presso la sezione di BG e SO"
author: " "
date: " "
output: 
...
- Ore lavorate : dati delle presenze in minuti/mese per matricola dal software SIGMA (non più attivo dal 01/09/2020)
del personale di comparto

- Unità di aggregazione dati : Laboratorio/tempo 
- Tempo standard : 36 h/settimanali x 48 settimane lavorative 
...
- Una persona che lavora 40 h settimana corrisponde a 40/36 = 1.25 FTE
- Due persone che lavorano 18h settimana corrispondono a 2*18/36 = 1 FTE

$$ \text{FTE}_{u} = \frac{\sum \text{numero ore erogate}_{u}}{\sum\text{numero di ore standard}_{u} } $$
...
- si decide di assegnare l'obiettivo a 8 operatori del comparto

- ore per persona a settimana da dedicare all'obiettivo = 0.125*36 = 4.5 h /settimana / persona

- ogni operatore coinvolto dovrà usare 4.5*48 = 216 h

- % di ore standard per operatore da allocare all'obiettivo = 216/1728 = 12%
