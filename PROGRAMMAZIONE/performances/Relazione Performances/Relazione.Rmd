...
Per la misurazione della performance organizzativa di ente, l’istituto si è dotato di uno strumento che è il «**Livello sintetico di Ente», il quale rappresenta la media aritmetica di tutti gli obiettivi strategici raggiunti dall’Istituto**. Nell’anno 2020 il Livello Sintetico di Ente presenta una percentuale dell’86%, rispetto ad un target dell’83%, in netta diminuzione rispetto all’anno precedente (90%). E’ necessario precisare che l’intero processo del ciclo di gestione delle performance ha subito non poche difficoltà a causa dell’emergenza sanitaria da covid19, che ha comportato un ritardo delle sue fasi e un impatto sul raggiungimento di alcuni obiettivi. Nel corso dell’anno 2020 l’Istituto è stato impegnato principalmente nel fronteggiare la pandemia, destinando risorse, capacità e competenze a tal fine.
