...
library("hrbrthemes")
library("here")
datiatt <- read_excel(here("programmazione", "data", "raw","BGSOBI2019.xlsx"))
anag <- read_excel(here("programmazione", "data", "raw","HR.xlsx"))
time <- read_excel( here("programmazione", "data", "raw", "personaleBgSoVa.xlsx"))
...
- Tempo standard : 36 h/settimanali x 45.6 settimane lavorative (escluse 6.4 settimane di ferie pari a 32 gg come da contratto ) del **personale di comparto**
...
---
# Full Time Equivalent
- 1 FTE = <span style="color:blue">**un individuo a tempo pieno con contratto di 36h/settimanali (1641.6 h/anno)**</span>
<br>
...
myfile <- here("programmazione", "data", "raw", "newdati3.csv")
dati<-read.csv(myfile,  header=T, sep=";", fileEncoding="latin1")
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
p <- read_excel(here("programmazione", "data", "raw", "P1.xlsx"))
p %>% 
...
--
- ogni operatore coinvolto dovrà usare 4.5*45.6 = 205.2 h/anno

--
- % di ore standard per operatore da allocare all'obiettivo = 205.2/1641.6 = 12.5%
