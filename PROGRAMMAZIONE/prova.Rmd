...
- Tempo standard : 36 h/settimanali x 46.4 settimane lavorative (escluse 4.6 settimane di ferie pari a 28gg come da contratto ) del **personale di comparto**
...
$$\text{FTE}_{u} = \frac{\sum \text{numero ore erogate}_{u}}{\text{numero di ore standard} }$$
