...
-------------------------------------
```{r}
selectInput("t", "Attività", 
            c("Generale", "Ufficiale", "Non Ufficiale"), "Generale")
```
...
### ***Distribuzione dell'attività analitica per reparto pesata per il ricavo***

```{r fig.height=8.5, fig.width=200}
med<-reactive({
  riepilogo %>% 
    group_by(Reparto, Attività) %>% 
    filter(Attività==input$t) %>% 
